...
arguments
    ...
    options.StimulationSource (1,1) string {mustBeMember(options.StimulationSource,["1p_dmd","2p_spiral"])} = "1p_dmd"
end
...
stimulationSource=repmat(options.StimulationSource,n,1);
