...
for train=1:numel(conditionIndex)
    ...
    for p=1:pulseCount
        pulseId=pulseId+1;
        stimulationSource="1p_dmd";
        if c.is_null, stimulationSource="none"; end
        new=table(pulseId,string(c.condition_id), ...
            ...
            'VariableNames',{'pulse_id','condition_id','stimulation_source','onset_s','duration_s', ...
...
protocol=struct("schema_version","4.0.0","artifact_type","experiment_definition", ...
