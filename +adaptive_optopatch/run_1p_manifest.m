...
dmdCalibration=adaptive_optopatch.compare_stimulation_dmd_calibration( ...
    hardware.dmd,targets);
...
save_checkpoint();
    ...
    function record=build_trial_record(row,waveformSummary,config,folder)
        ...
        record.stimulation_dmd_calibration=dmdCalibration;
