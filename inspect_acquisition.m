...
viewer=struct( ...
    ...
    "fov_image_source","acquisition mean image", ...
...
displayReference=struct("reference_image",traces.mean_image, ...
...
title(referenceAxes,"Acquisition mean FOV"); hold(referenceAxes,"on");
