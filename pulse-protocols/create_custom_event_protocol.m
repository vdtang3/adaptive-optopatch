% Create a schema-4 definition from explicit event onsets and durations.
...
stimulation_source=["1p_dmd";"1p_dmd";"1p_dmd";"none"];
...
events=table(pulse_id,condition_id,stimulation_source,onset_s,duration_s,is_null, ...
