classdef TestBlueDmdAdvisoryPolicy < matlab.unittest.TestCase
    methods (Test)
        ...
        % ---------------------------------------------------------------
        % Planning-time drift is advisory; an unrunnable plan is not
        % ---------------------------------------------------------------
        function calibrationDriftIsAdvisoryButUnsafeStatesStillError(testCase)
            ...
            manifest=adaptive_optopatch.build_manifest(fovState.reference,targets, ...
                ...
                "FovState",fovState,"GuiDefaults",AoFixtures.guiDefaults());
            ...
            testCase.verifyError(@()adaptive_optopatch.build_manifest( ...
                ...
                "FovState",disabledFov,"GuiDefaults",AoFixtures.guiDefaults()), ...
